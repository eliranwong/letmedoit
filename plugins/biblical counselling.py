...
config.predefinedContexts["Christian Prayers"] = f"Write a prayer, integrating principles and teachings from the Bible, in relation to the input I am giving to you. Make sure that the Bible is used as a source of truth and as a framework for understanding human behavior, relationships, and the purpose of life. This is my input:"